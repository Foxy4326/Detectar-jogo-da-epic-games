...
<body>
  ...
  <script>
    ...
    const epicAPI = encodeURIComponent("https://store-site-backend-static.ak.epicgames.com/freeGamesPromotions?locale=pt-BR");
    ...
    async function fetchFreeGames() {
      ...
      try {
        const response = await fetch(proxyURL + epicAPI);
    ...
    fetchFreeGames();
    setInterval(fetchFreeGames, 600000); // Atualiza a cada 10 minutos
  </script>
</body>
</html>
